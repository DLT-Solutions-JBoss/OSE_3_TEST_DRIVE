...
#example bulk remove
echo /usr/bin/cli53 rrdelete "dlt-testdrive.com" "$ARGV[0]"
/usr/bin/cli53 rrdelete "dlt-testdrive.com" "$1"
#/usr/bin/cli53 rrdelete "dlt-testdrive.com" "master.i-b5e75a66"
